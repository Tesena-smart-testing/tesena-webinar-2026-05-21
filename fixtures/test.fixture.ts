...
import { TestUserKey, TestUserData, getTestUserData } from "../tests/testdata/testUsers"
...
export const test = base.extend<Fixtures, Options>({
    ...
    testUser: [async ({ testUserKey }, use) => {
    ...
    authentication: [async ({ browser, testUserKey, testUser, texts }, use) => {
